...
//  Quizzler
//
//  Created by Treinamento on 16/08/19.
...
class QuestionBank{
    var list = [Question]()//Contains only question objects
    
    //Here all the data that we're gonna use
    
    init(){
        let newQuestionObject = Question(text: "data", correctAnswer: true)
        
        // Creating a quiz item and appending/acrescentando it to the list
